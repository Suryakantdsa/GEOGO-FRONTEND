...
const MovieCard = () => {
    return (
        <div className='w-[300px] h-[400px] md:w-[250px] md:h-[350px] flex flex-col p-2 m-2 border border-green-500 rounded-md shadow-xl'>
            ...
            <h1 className='w-full font-bold text-xl text-center mt-2'>Satyaprem Ki Katha <span className='font-normal'>(2015)</span></h1>
