...
const Navbar = () => {
  ...
  return (
    <nav className="h-[10%] flex px-1 py-2 md:justify-between justify-center items-center bg-black">
        ...
        <Link to={"/"}>
          <div className="md:flex items-center border-[2px] mx-4 border-green-300 hidden py-5 h-[2.1rem] ">
            ...
            <div className="flex flex-col justify-center px-2 font-bold h-[60%]">
              <span className="text-green-400 text-[0.8rem]">
                Recommendation
              </span>
      ...
      <div
        id="searchbar"
        className="h-[2rem] mx-2  md:h-[2.5rem] flex justify-between bg-white w-[80%] md:w-[70%] rounded-l-full rounded-r-full">
        <input
          type="text"
        ...
        <button
          ...
          className=" bg-green-300 w-[10%] rounded-r-full h-full ">
      ...
      <div id="wishlist" className="text-white mx-4 hidden md:flex">
        ...
        <span
          id="boot-icon"
          className="bi bi-bookmark-plus text-4xl ml-1 text-green-500"></span>
      </div>
    </nav>
  );
};
